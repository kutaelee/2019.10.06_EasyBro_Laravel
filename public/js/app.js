...
$(document).ready(function () {
  ...
  $(window).scroll(function (e) {
    ...
    var boardSectionTop = $('#board-section').offset().top - 100;
    var linkSectionTop = $('#link-section').offset().top - 100;
    var infoSectionTop = $('#info-section').offset().top - 100;
  ...
  $('#join-btn').click(function () {
    ...
    if (joinPassCheck && joinPass && joinIdCheckVal && joinEmail) {
      var id = $('#join-username').val();
      var pw = $('#join-password').val();
  ...
  $(document).on('click', '#list-destroy-btn', function () {
    var listNo = $('.list-destroy-name').attr('num');
    $.ajax({
      type: 'DELETE',
      url: 'lists/' + listNo,
      data: {
        ...
        if (data[0]) {
          ...
          try {
            for (var _iterator = data[0][Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
              ...
              $('.list-edit-table').append('<tr><td><input type="text" maxlength="50" value="' + _item.LINK_NAME + '" num="' + _item.LINK_NO + '"></td> <td><input type="text" maxlength="200" value="' + _item.LINK_URL + '"></td></tr>');
            }
          } catch (err) {
  ...
  $(document).on('click', '.link-destroy-icon', function () {
    var linkNo = $(this).attr('num');
    var linkName = $('#link-' + linkNo + ' a').text();
      ...
      success: function success(data) {
        ...
        try {
          for (var _iterator2 = data[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
            ...
            $('.share-board-table').append('<tr><td>' + _item2.LINK_NAME + '</td>' + '<td><a href="' + _item2.LINK_URL + '" target="_blank">' + _item2.LINK_URL + '</a></td></tr>');
          }
        } catch (err) {
  ...
  $(document).on('click', '#prev-page', function () {
    if (currentPageNum > 10) {
      var minusNum = currentPageNum % 10;
  ...
  $(document).on('click', '#next-page', function () {
    ...
    if (currentPageNum > 10) {
      var plusNum = 10 - currentPageNum % 10 + 1;
      currentPageNum = currentPageNum + plusNum;
    } else {
      var _plusNum = 10 - currentPageNum + 1;

      currentPageNum = currentPageNum + _plusNum;
    }
  ...
  $('#change-password').keyup(function () {
    var pw = $(this).val();
    var pwCheck = $('#change-password-check').val();
...
function alert(id, title, msg) {
  ...
  if (id === 'danger') {
    dangerAlertCloseTimer = setTimeout(function () {
      clearTimeout(dangerAlertCloseTimer);
  ...
  if (id === 'success') {
    successAlertCloseTimer = setTimeout(function () {
      clearTimeout(successAlertCloseTimer);
  ...
  return new Promise(function (resolve) {
    if (userData.userNo) {
      $.ajax({
        ...
        success: function success(listData) {
          $('.list-box-ul').text('');
          ...
          try {
            for (var _iterator3 = listData[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
              var _item3 = _step3.value;
              $('.list-box-ul').append('<li class="list-item" id="list-' + _item3.LIST_NO + '" number="' + _item3.LIST_NO + '" content="' + _item3.LIST_NAME + '"><span class="list-item-number">' + i + '</span><a class="list-item-name">' + _item3.LIST_NAME + '</a> <span class="list-destroy-icon"> - </span> <span class="link-add-icon"> + </span> <img src="/img/listEdit.png" class="list-edit-icon"> </li>');
              i++;
            }
          } catch (err) {
  ...
  return new Promise(function (resolve) {
    ...
    if (listData) {
      $.ajax({
        ...
        success: function success(linkData) {
          $('.link-item-ul').text('');
          ...
          try {
            for (var _iterator4 = linkData[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
              ...
              try {
                for (var _iterator5 = link[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
                  var _item4 = _step5.value;
                  $('#list-' + _item4.LIST_NO).append('<ul class="link-item-ul"><li class="link-item" id="link-' + _item4.LINK_NO + '" url="' + _item4.LINK_URL + '"><a class="link-item-name">' + _item4.LINK_NAME + '(' + _item4.LINK_URL + ')</a> <span class="link-destroy-icon" num="' + _item4.LINK_NO + '">-</span> </li></ul>');
                }
              } catch (err) {
      ...
      success: function success(data) {
        ...
        try {
          for (var _iterator6 = data[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
            ...
            $('.my-list').append('<option value="' + _item5.LIST_NO + '">' + _item5.LIST_NAME + '</option>');
    ...
    success: function success(data) {
      ...
      try {
        for (var _iterator7 = data[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
          ...
          $('.list-share-table').append('<tr class="share-item" num="' + _item6.DOC_NO + '"><td>' + _item6.DOC_NO + '</td>' + '<td class="share-item-name">' + _item6.LIST_NAME + '</td>' + '<td>' + _item6.LIST_CREATED_AT + '</td>' + '<td>' + _item6.DOC_CREATE_AT + '</td>' + '<td>' + _item6.USER_ID + '</td>' + '<td>' + _item6.SHARE_COUNT + '</td></tr>');
        }
      } catch (err) {
...
function pagingInit(count, currentPageNum) {
  ...
  if (count <= 10) {
    ...
    for (var i = startPageNum; i <= maxPageNum; i++) {
...
var joinPass = false;
var joinIdCheckVal = false;
var joinEmail = false;
/* 알렛 타이머 변수 */

var dangerAlertCloseTimer;
var successAlertCloseTimer;
/* 페이징 변수 */
...
var keyword = null;
var selected = null;
var linkKeyword = null;
/* 비밀번호 변경 변수 */

var changePw = false;
var changePwCheck = false;
...
/***/ 0:
/*!*************************************************************************************!*\
  !*** multi ./resources/js/app.js ./public/js/index.js ./resources/css/tailwind.css ***!
  \*************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /home/vagrant/code/Laravel/resources/js/app.js */"./resources/js/app.js");
__webpack_require__(/*! /home/vagrant/code/Laravel/public/js/index.js */"./public/js/index.js");
module.exports = __webpack_require__(/*! /home/vagrant/code/Laravel/resources/css/tailwind.css */"./resources/css/tailwind.css");
